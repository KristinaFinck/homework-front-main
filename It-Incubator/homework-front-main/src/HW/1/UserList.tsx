...
type AddressType = {
  street: string; // ПОДПРАВЛЯЕМ any - поправила
  city: string; // ПОДПРАВЛЯЕМ any - поправила 
};

type UserType = {
  // ПРИДЕТСЯ САМОМУ) - написала пропсы
    id: number
    name: string
    age: number
    address: AddressType
...
type UserListPropsType = {
  users: UserType[]; // ПО МОЕМУ ЧЕГО-ТО НЕ ХВАТАЕТ... - добавила значок массива
};
